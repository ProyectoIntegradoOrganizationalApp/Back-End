                ...
                match board_found {
                    Ok(mut board) => {
                        ...
                        match updated_project {
                            ...
                            Err(_) => Err(GenericError {error: true, message: "Error updating the board".to_string()})
                        }
                    },
                ...
                match board_found {
                    Ok(board) => {
                        ...
                        match deleted {
                            ...
                            Err(_) => Err(GenericError { error: true, message: "Error deleting the board".to_string() })
                        }
                    },
