...
('1', 'Befriend', 'Make friends on the platform', 'friends.png', '{1, 5, 20}'),
...
('5', 'Project Party', 'Invite friends to join your projects', 'invite.png', '{1, 20, 50}'),
...
('12', 'Project Joiner', 'Join an existing project', 'join.png', '{1, 5, 20}')